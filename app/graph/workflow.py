...
builder.add_node("papers", paper_agent)
...
# Always retrieve long-term memory first
builder.add_edge(START, "memory")

# Then generate the research plan
...
# Planner dynamically chooses research agents
...
builder.add_edge("merge", "research")
...
builder.add_edge("report", "memory_write")
